 ...
 * @var string $toDate
 * @var string $drNo
 * @var list<array{client_name?: string|null, dr_no?: string|null, date?: string|null, due_date?: string|null, payment_term?: int|string|null, total_amount?: int|float|string|null, balance?: int|float|string|null}> $deliveries
...
<body>
    ...
    <div class="header">
        ...
        <div class="report-title">Deliveries Report</div>
    ...
    <table class="table">
        ...
        <tbody>
            <?php if (empty($deliveries)): ?>
                <tr>
                    <td class="text-center" colspan="8">No deliveries found for the selected date range.</td>
                </tr>
            <?php else: ?>
