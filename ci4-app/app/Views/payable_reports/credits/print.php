...
<head>
    <meta charset="utf-8">
    <title>Supplier Credits Report</title>
    <style>
        @page {
            margin: 24px;
        }
...
<body>
    <div class="header">
        ...
        <div class="report-title">Supplier Credits Report</div>
        <div class="meta">Available Balance Sort: <?= esc(strtoupper($sort ?? 'asc')) ?></div>
    </div>
